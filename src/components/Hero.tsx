  ...
  return (
    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-20 flex flex-col md:flex-row md:justify-between md:gap-12 text-center md:text-left">
       ...
       {/* C. BLOQUE DE HORARIOS (DERECHA) */}
        <div className="w-full md:w-2/5 lg:w-1/3 bg-bg-main/70 backdrop-blur-sm p-6 rounded-xl border border-white/10 shadow-xl self-start">
